            ...
            if ($per == 1) {
                switch ($request->ac) {
                    ...
                    case 13:
                            ...
                            WorksAssignment::where('id', '=', $request->id)->update(['real_note' => $data['real_note'],'income_total' => $data['income_total'],'spending_total' => $data['spending_total'],'seri_number' =>$data['seri_number'],'admin_check' => 1 ]);
