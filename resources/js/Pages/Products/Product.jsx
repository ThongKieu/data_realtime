                    ...
                    <Card className='grid grid-cols-2 gap-4 p-2'>
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <Input
                                ...
                                value={formData.sale_price_product}
                            ...
                            <Input
                                ...
                                value={formData.provider_product}
                                id="provider_product"
                                onChange={handleChange}/>
                            <Input
                                name='phone_product'
                ...
                />
                        ...
                        <div className="grid border border-orange-400 rounded-xl p-3">
                           <div className='grid grid-cols-2'> <Typography>
                                Tên sản phẩm: <b>{formData.name_product }</b>
                            </Typography>
                            <Typography>
                                Mã Sản Phẩm: <b>{codeProduct }</b>
                            </Typography>
                            <Typography>
                                Giá Mua: <b>{formData.price_product }</b>
                            </Typography>
                            <Typography>
                                Giá Bán: <b>{formData.sale_price_product }</b>
                            </Typography>
                            <Typography>
                                Thông tin đại lý: <b>{ formData.provider_product}</b>
                            </Typography>
                            <Typography>
                                Số Liên Hệ: <b>{ formData.phone_product }</b>
                            </Typography>
                            <Typography>
                                Hình sản phẩm:
                            </Typography></div>
