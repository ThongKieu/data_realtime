...
Route::middleware('auth')->group(function () {
    Route::get('/test-location', function () {return Inertia::render('TestLocation');});
    ...
    Route::post('/export-quote', function () {return Inertia::render('Export_Quote');})->name('Export_Quote');
